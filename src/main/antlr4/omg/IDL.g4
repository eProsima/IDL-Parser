 ...
 */	
definition [Vector<Annotation> annotations] returns [Pair<Definition, TemplateGroup> dtg = null]
@init {
    ...
    :   type_decl[annotations] SEMICOLON { tdtg=$type_decl.returnPair; if(tdtg!=null){ $dtg = new Pair<Definition, TemplateGroup>(tdtg.first(), tdtg.second());}}  // Type Declaration
    ...
    |   interface_or_forward_decl[annotations] SEMICOLON { itg=$interface_or_forward_decl.itg; if(itg!=null){$dtg = new Pair<Definition, TemplateGroup>(itg.first(), itg.second());}} // Interface
...
aux_definition [Vector<Annotation> annotations] returns [Pair<Definition, TemplateGroup> dtg = null]
 ...
 */
export [Vector<Annotation> annotations] returns [Pair<Export, TemplateGroup> etg = null]
@init {
        // TODO Cambiar esto. No me gusta la forma.
    ...
    :   type_decl[annotations] SEMICOLON { tetg=$type_decl.returnPair; if(tetg!=null){$etg = new Pair<Export, TemplateGroup>(tetg.first(), tetg.second());} }  // Type Declaration
    ...
    |   op_decl[annotations] SEMICOLON { oetg=$op_decl.returnPair; if(oetg!=null){$etg = new Pair<Export, TemplateGroup>(oetg.first(), oetg.second());}}  // Operation
    |   type_id_decl SEMICOLON
    |   type_prefix_decl SEMICOLON
	|	annotation_appl
        {
...
aux_export [Vector<Annotation> annotations] returns [Pair<Export, TemplateGroup> etg = null]
...
type_decl [Vector<Annotation> annotations] returns [Pair<TypeDeclaration, TemplateGroup> returnPair = null]
@init {
    ...
    |   constr_forward_decl )
	{
	    ...
	    if(ttg!=null)
        {
            ...
            TypeDeclaration typedeclaration = new TypeDeclaration(ctx.getScopeFile(), ctx.isInScopedFile(), ctx.getScope(), name, ttg.first(), tk);
	        ...
	        $returnPair = new Pair<TypeDeclaration, TemplateGroup>(typedeclaration, ttg.second());
        }
	}
    ;
