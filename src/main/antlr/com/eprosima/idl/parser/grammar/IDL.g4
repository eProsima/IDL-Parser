...
member_def [StructTypeCode structTP] returns [Vector<Pair<Pair<Pair<String, Token>, TemplateGroup>, Member>> ret = null]
...
member [StructTypeCode structTP] returns [Vector<Pair<Pair<Pair<String, Token>, TemplateGroup>, Member>> ret = new Vector<Pair<Pair<Pair<String, Token>, TemplateGroup>, Member>>()]
@init{
...
@init {
    ...
    :   ( (KW_SEQUENCE)
        LEFT_ANG_BRACKET simple_type_spec[null] { type=$simple_type_spec.returnPair.first(); template=$simple_type_spec.returnPair.second(); def=$simple_type_spec.def; } COMA positive_int_const { maxsize=ctx.evaluate_literal($positive_int_const.literalStr); } RIGHT_ANG_BRACKET
    |   (KW_SEQUENCE)
...
@init {
    ...
    Definition def = null;
        ...
        LEFT_ANG_BRACKET simple_type_spec[null] { type=$simple_type_spec.returnPair.first(); def=$simple_type_spec.def; } COMA positive_int_const { maxsize=ctx.evaluate_literal($positive_int_const.literalStr); } RIGHT_ANG_BRACKET
    |   KW_SET
